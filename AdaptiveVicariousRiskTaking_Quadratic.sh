#!/bin/bash
#SBATCH --job-name=Cups_3dlmer_BFvsParent_PM_quad
#SBATCH --output=output/Cups_3dlmer_BFvsParent_PM_quad.log
...
3dLMEr -prefix 3dLMEr_pm_quad -jobs 28 \
 ...
 -gltCode grade_6_2.Uncertain_PM_BF  'decision : 1*unc_pm_bf grade_6_2 : ' \
 -gltCode grade_6_2.Uncertain_PM_Parent  'decision : 1*unc_pm_pa grade_6_2 : ' \
 -gltCode grade_6_2.Uncertain_PM_BF-Uncertain_PM_Parent  'decision : 1*unc_pm_bf -1*unc_pm_pa grade_6_2 : ' \
 -dataTable \
